...
#MainMenu, footer, header, .stDeployButton, div[data-testid="stDecoration"] {display:none!important}
.block-container {padding:0!important;max-width:100%!important}

/* === SIDEBAR === */
section[data-testid="stSidebar"] {background:var(--dark)!important;min-width:260px!important;max-width:260px!important}
section[data-testid="stSidebar"]>div:first-child {padding:0!important;padding-bottom:80px!important}
...
div.stRadio>div {flex-direction:column!important;gap:0!important;padding:16px 0!important}
div[role="radiogroup"]>label[data-baseweb="radio"]>div:first-child {display:none!important}
section[data-testid="stSidebar"] div[role="radiogroup"]>label[data-baseweb="radio"] {
    background:transparent!important;padding:12px 32px!important;margin:0!important;
...
.sidebar-status::before {content:'';width:6px;height:6px;background:var(--accent);border-radius:50%;animation:pulse 2s infinite}
@keyframes pulse {0%,100%{opacity:1}50%{opacity:0.4}}

/* === ANIMATIONS === */
@keyframes fadeIn {from{opacity:0;transform:translateY(16px)}to{opacity:1;transform:translateY(0)}}
.animate {animation:fadeIn 0.5s ease both}
...
@media (max-width:768px) {
    .hero {padding:32px 24px!important;min-height:auto!important}
    .stats-bar {flex-wrap:wrap;gap:24px 40px}
    .featured-project {margin:40px 24px!important;padding:32px!important}
    .featured-metrics {flex-wrap:wrap;gap:24px}
    .projects-grid {grid-template-columns:1fr!important;padding:0 24px 40px!important}
    .quote-section {margin:0 24px 40px!important;padding:40px 24px!important}
    .case-study {padding:40px 24px!important}
    .about-hero {grid-template-columns:1fr!important;gap:32px!important;padding:40px 24px!important}
    .about-section {padding:40px 24px!important}
    .skills-grid, .cert-grid {grid-template-columns:1fr!important}
    .timeline-item {grid-template-columns:1fr!important;gap:8px!important}
    .connect-hero {padding:60px 24px!important}
    .connect-cards {grid-template-columns:repeat(2,1fr)!important}
    .testimonials {padding:40px 24px!important}
...
.featured-project::before {
    content:'';position:absolute;top:-50%;right:-30%;width:70%;height:200%;
    background:radial-gradient(ellipse,rgba(13,148,136,0.12) 0%,transparent 70%);pointer-events:none
}
...
.case-section li::before {content:'→';position:absolute;left:0;color:var(--accent);font-size:12px}
.case-quote {background:var(--accent-light);border-radius:10px;padding:24px 28px;margin:32px 0}
.case-quote p {font-family:'Fraunces',serif!important;font-size:16px;font-style:italic;color:var(--fg);line-height:1.6;margin:0!important}
...
/* === STREAMLIT BUTTON === */
.stButton>button {font-family:'Inter',sans-serif!important;font-size:13px!important;font-weight:500!important;padding:10px 20px!important;border-radius:6px!important}
</style>
...
if page == "Home":
    ...
    st.markdown('''
    <div class="featured-project animate delay-2">
        ...
        <div class="featured-tags">
            <span class="featured-tag">Snowflake</span><span class="featured-tag">Power BI</span><span class="featured-tag">Python</span><span class="featured-tag">250+ Users</span>
        </div>
    </div>
    <div class="projects-grid">
        ...
        <div class="project-card animate delay-3">
            ...
            <p class="project-desc">Replaced 47 manual Excel macros with automated Python pipelines. Error rate: 15% → 0%.</p>
            <div class="project-metrics">
    ...
    <div class="quote-section animate delay-3">
...
# === WORK ===
    ...
    st.markdown('''
    <div class="work-hero"><h1 class="work-hero-title">Selected Work</h1><p class="work-hero-sub">Deep dives into problems I've solved</p></div>
    <div class="case-study">
        <div class="case-inner">
            ...
            <div class="case-section"><h3 class="case-section-title">The Mess</h3>
                ...
                <ul><li>CFO getting 5 different revenue numbers at every board meeting</li><li>Field teams created 47 shadow Excel trackers</li><li>Previous BI lead quit mid-project</li></ul>
            </div>
            <div class="case-section"><h3 class="case-section-title">Why This Was Hard</h3>
            ...
            <div class="case-section"><h3 class="case-section-title">My Approach</h3>
            ...
            <div class="case-section"><h3 class="case-section-title">What Went Wrong</h3>
            ...
            <div class="case-quote"><p>"For the first time in two years, I walked into a board meeting with confidence in our numbers."</p><cite>— CFO</cite></div>
        </div>
    </div>
    <div class="case-study">
        <div class="case-inner">
            ...
            <div class="case-section"><h3 class="case-section-title">Results</h3>
                <ul><li>Value-based ads beat feature-based by 33% (p=0.03)</li><li>Best combo: Meme #2 + Learn More CTA + Comment prompt</li><li>36% lower CPM with engagement-driven strategies</li></ul>
            </div>
            <div class="case-section"><h3 class="case-section-title">What Went Wrong</h3>
    ...
    <div class="case-study">
        <div class="case-inner">
            ...
            <div class="case-quote"><p>"Finance finally trusts the 'automated' reports. That hasn't happened in years."</p><cite>— VP of Finance</cite></div>
        </div>
    </div>
    ''', unsafe_allow_html=True)
...
# === ABOUT ===
    ...
    <div class="about-section">
        ...
        <div class="timeline">
            <div class="timeline-item"><div class="timeline-year">2021 — Present</div><div class="timeline-content"><p class="timeline-role">BI Manager</p><p class="timeline-company">Advantage Solutions</p><p class="timeline-desc">Built national Power BI ecosystem with Snowflake. Unified 5 sales domains. Automated 99+ vendor pipelines. Managed 7 regional managers.</p></div></div>
            <div class="timeline-item"><div class="timeline-year">2017 — 2021</div><div class="timeline-content"><p class="timeline-role">BI Strategy & Analytics Manager</p><p class="timeline-company">Modern Home Station</p><p class="timeline-desc">Cross-channel attribution (GA4, Shopify, Meta). A/B testing program. Revenue: +45% FY19, +85% FY20.</p></div></div>
            <div class="timeline-item"><div class="timeline-year">2016 — 2017</div><div class="timeline-content"><p class="timeline-role">BI & Strategic Development Manager</p><p class="timeline-company">China Unicom America</p><p class="timeline-desc">GTM pricing models. $2M+ revenue projections. Automated churn reporting.</p></div></div>
            <div class="timeline-item"><div class="timeline-year">2014 — 2016</div><div class="timeline-content"><p class="timeline-role">BI Project Analyst</p><p class="timeline-company">Marshall Electronics</p><p class="timeline-desc">50+ product launches, $5M annual sales. 95% on-time rate.</p></div></div>
            <div class="timeline-item"><div class="timeline-year">2010 — 2014</div><div class="timeline-content"><p class="timeline-role">Senior Business Analyst</p><p class="timeline-company">Cadence Acoustic Ltd.</p><p class="timeline-desc">Migrated Excel to SQL dashboards. Managed $500M product lines.</p></div></div>
        </div>
    </div>
    <div class="about-section">
        <h2 class="section-title">Education</h2>
        <div class="timeline">
            <div class="timeline-item" style="border-bottom:none"><div class="timeline-year">2010</div><div class="timeline-content"><p class="timeline-role">B.S. Business Administration</p><p class="timeline-company">University of California, Riverside</p></div></div>
        </div>
    </div>
    <div class="about-section">
    ...
    <div class="about-section">
        ...
        <div class="cert-grid">
            ...
            <div class="cert-card"><p class="cert-name">Neural Networks & Deep Learning</p><p class="cert-issuer">DeepLearning.AI · 2024</p></div>
...
# === CONNECT ===
    ...
    <div class="connect-hero">
        ...
        <div class="connect-cards">
            <div class="connect-card"><div class="connect-card-icon">📧</div><div class="connect-card-label">Email</div><div class="connect-card-value"><a href="mailto:jason.chang01022024@gmail.com">jason.chang01022024@gmail.com</a></div></div>
            <div class="connect-card"><div class="connect-card-icon">💼</div><div class="connect-card-label">LinkedIn</div><div class="connect-card-value"><a href="https://linkedin.com/in/jchang0102" target="_blank">linkedin.com/in/jchang0102</a></div></div>
            <div class="connect-card"><div class="connect-card-icon">📱</div><div class="connect-card-label">Phone</div><div class="connect-card-value">(626) 203-3319</div></div>
            <div class="connect-card"><div class="connect-card-icon">📍</div><div class="connect-card-label">Location</div><div class="connect-card-value">Hacienda Heights, CA</div></div>
        </div>
    </div>
    <div class="testimonials">
        <h2 class="section-title" style="text-align:center;margin-bottom:40px">What Colleagues Say</h2>
        <div class="testimonials-grid">
            <div class="testimonial-card"><p class="testimonial-quote">"Jason has a rare ability to translate complex data into stories that executives actually act on. He doesn't just answer questions — he asks better ones."</p><p class="testimonial-author">[Name]</p><p class="testimonial-role">VP of Sales</p></div>
            <div class="testimonial-card"><p class="testimonial-quote">"Most analysts give you data. Jason gives you decisions. He made our CEO actually look forward to reviewing dashboards."</p><p class="testimonial-author">[Name]</p><p class="testimonial-role">Director of Operations</p></div>
            <div class="testimonial-card"><p class="testimonial-quote">"I've worked with a lot of BI people. Jason is the first one who understood that data without context is just noise."</p><p class="testimonial-author">[Name]</p><p class="testimonial-role">CFO</p></div>
            <div class="testimonial-card"><p class="testimonial-quote">"Jason doesn't just build dashboards — he changes how teams think about measurement. That's rare."</p><p class="testimonial-author">[Name]</p><p class="testimonial-role">Product Manager</p></div>
        </div>
    </div>
    ''', unsafe_allow_html=True)
